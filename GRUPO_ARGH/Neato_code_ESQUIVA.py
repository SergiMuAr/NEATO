...
if __name__ == "__main__":
	...
	for i in range (0,200):
		...
		'''centralLeftSensorValue2 = (var[3] if var[3] < distDetection else distDetection)
		outerLeftSensorValue2 = (var[4]  if var[4] < distDetection else distDetection)
		centralRightSensorValue2 = (var[1] if var[1] < distDetection else distDetection)
		outerRightSensorValue2 = (var[0] if var[0] < distDetection else distDetection)
		centralSensorValue2 = (var[2] if var[2] < distDetection else distDetection)'''

		'''minLeft = min(centralLeftSensorValue2,outerLeftSensorValue2)
		maxLeft = max(centralLeftSensorValue2,outerLeftSensorValue2)
		minRight = min(centralRightSensorValue2,outerRightSensorValue2)
		maxRight = max(centralRightSensorValue2,outerRightSensorValue2)'''
